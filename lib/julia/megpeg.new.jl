...
#df = CSV.File(GzipDecompressorStream(open("/nfs/mm-isilon/bioinfcore/ActiveProjects/weishwu/test/ASEprep/test_data/ase_by_snp.csv.gz")); missingstring=["NA"]) |> DataFrame
#df = CSV.read("/nfs/mm-isilon/bioinfcore/ActiveProjects/weishwu/test/ASEprep/test_data/ase_by_snp.csv.gz", DataFrame; missingstring=["NA"])

path = "/nfs/mm-isilon/bioinfcore/ActiveProjects/weishwu/test/ASEprep/test_data/ase_by_snp.csv.gz"
df = CSV.File(GzipDecompressorStream(open(path)); missingstring=["NA"]) |> DataFrame
