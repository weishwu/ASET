...
nextflow run main.nf \
    ...
    -params-file test_data/params.gsnap.yaml \
    -resume \
    -with-dag test_data/reports_gsnap/run_report/dag.png \
    -with-trace test_data/reports_gsnap/run_report/trace.txt \
    -with-report test_data/reports_gsnap/run_report/report.html \
    -with-timeline test_data/reports_gsnap/run_report/timeline.html \
